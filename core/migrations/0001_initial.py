    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('admin', 'Admin'), ('provider_poc', 'Provider POC'), ('university_poc', 'University POC')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('file', models.FileField(blank=True, null=True, upload_to='contracts/files/')),
        ...
        migrations.AddField(
            model_name='contract',
            name='stream',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contracts', to='core.stream'),
        ),
        migrations.AddField(
            model_name='contract',
            name='tax_rate',
